...
import trueMusicData from "./material/data1.json"

export default function MusicPlayer(){
    const primaryMusicData = trueMusicData;
    ...
    function returnIndex(data){
      let value;
      if(data < 0){
        value = primaryMusicData.length - 1;
      } else if(data > primaryMusicData.length -1){
        value = 0;
      } else {
        value = data;
      }
